...
<!-- Main Header -->
  <header class="main-header no-print">
    <a href="{{route('home')}}" class="logo">
                       <img src="{{ asset( 'uploads/business_logos/' . Session::get('business.logo') ) }}" alt="Logo" width="230px" >
      ...
      <div class="navbar-custom-menu">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu">
            <li>
              <a style="cursor: pointer;" class="btn-modal" data-href="{{action('ContactController@create', ['type' => 'customer'])}}" data-container=".contact_modal">
                <i class="fas fa-user" aria-hidden="true"></i> Add Customer
              </a>
            </li>
            <li>
              <a href="/sells/create">
                <i class="fa fas fa-arrow-circle-up"></i> Add Sale
              </a>
            </li>
            <li>
              <a href="/purchases/create">
                <i class="fa fas fa-arrow-circle-down"></i> Add Purchase
              </a>
            </li>
            <li>
              <a href="/expenses/create">
                <i class="fa fas fa-minus-circle"></i> Add Expense
              </a>
            </li>
            <hr>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                @if(!empty($profile_photo))
                  <img src="{{$profile_photo->display_url}}" class="" alt="User Image" width="150px" height="auto">
