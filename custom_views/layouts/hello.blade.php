            ...
            <div class="col-md-5 col-sm-5 hidden-xs left-col eq-height-col" >
                <div class="left-col-content login-header"> 
                    ...
                    @if(file_exists(public_path('uploads/logo.png')))
                        <img src="/uploads/logo.png" alt="Logo" width="250">
                    @else
                  ...
                  <div class="mother-content-position"> 
                    <p>© 2022 Babsaa, a Trixo Lab Company. All rights reserved</p>
                    <!--<a class="mother-content" href="https://trixolab.com" target="_blank"> by <img src="/uploads/trixolab-logo.png" class="mother-logo" alt="Mother Company Logo" width="75"></a>--> </div>
                </div>
            </div>
