...
use App\Http\ReportPrintController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/user-inspection/{id}', 'ManageUserController@signInAsUser')->name('sign-in-as-user');
    ...
    // Delivery Partners
    Route::get('/delivery-partners', 'DeliveryPartnerController@index');
    Route::match(['get', 'post'], '/delivery-partners/create', 'DeliveryPartnerController@create');
    ...
    // route for payment print (by shihab)
    Route::get('/reports/sell-payment-report-print', 'ReportPrintController@sellPaymentReportPrint');
});
