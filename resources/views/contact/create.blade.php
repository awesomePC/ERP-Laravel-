            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('mobile', null, ['class' => 'form-control', 'required', 'minlength' => '11', 'maxlength' => '11', 'placeholder' => __('contact.mobile')]); !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('alternate_number', null, ['class' => 'form-control', 'minlength' => '11', 'maxlength' => '11', 'placeholder' => __('contact.alternate_contact_number')]); !!}
                    </div>
                </div>
            </div>
            <div class="col-md-3">
