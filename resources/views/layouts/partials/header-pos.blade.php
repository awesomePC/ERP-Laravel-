  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      @endif
        ...
        <button type="button" class="btn btn-primary btn-flat m-6 btn-xs m-5 pull-right" data-toggle="modal" data-target="#recent_transactions_modal" id="recent-transactions"> 
        ...
        @if(empty($pos_settings['disable_suspend']))
				<button type="button" 
				class="@if($is_mobile) col-xs-6 @endif btn bg-red btn-flat m-6 btn-xs m-5 pull-right no-print pos-express-finalize" 
			...
			@if(empty($pos_settings['disable_credit_sale_button']))
				...
				<button type="button" 
				class="btn bg-purple btn-flat m-6 btn-xs m-5 pull-right no-print pos-express-finalize @if($is_mobile) col-xs-6 @endif" 
      ...
      @if(empty($edit))
				<button type="button" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right text-white @if($is_mobile) col-xs-6 @else btn-flat @endif" id="pos-cancel"> <i class="fas fa-window-close"></i> @lang('sale.cancel')</button>
			@else
				<button type="button" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right text-white hide @if($is_mobile) col-xs-6 @else btn-flat @endif" id="pos-delete"> <i class="fas fa-trash-alt"></i> @lang('messages.delete')</button>
			@endif
