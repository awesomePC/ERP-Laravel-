...
<div class="row" style="visibility: hidden;">
	<div class="pos-form-actions text-center" style="padding: 0 !important;">
		<div class="col-md-12 pos_action_buttons">
			@if($is_mobile)
			...
			@if(empty($edit))
				<button type="button" class="btn btn-danger btn-default text-white @if($is_mobile) col-xs-6 @else btn-flat @endif" id="pos-cancel"> <i class="fas fa-window-close"></i> @lang('sale.cancel')</button>
			@else
				<button type="button" class="btn btn-danger btn-default text-white hide @if($is_mobile) col-xs-6 @else btn-flat @endif" id="pos-delete"> <i class="fas fa-trash-alt"></i> @lang('messages.delete')</button>
			@endif
