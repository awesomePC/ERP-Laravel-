...
<div class="ms-payableAmount">
	0.00
	<script>
		const payableAmount = document.querySelector('#total_payable');
		const floatSelector = document.querySelector('.ms-payableAmount');
		
		if (window.innerWidth <= 768) {
			setInterval(() => {
				floatSelector.innerText = payableAmount.innerText;
			}, 2000);
		}
	</script>
</div>
