      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            {!! Form::file('watermark', ['accept' => 'image/*']); !!}
            <span class="help-block">@lang('lang_v1.invoice_logo_help', ['max_size' => '1 MB'])<br> @lang('lang_v1.invoice_logo_help2')</span>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <label for="cash_to_return">Signature Section:</label>
            <select name="signature" id="" class="form-control form-select">
              <option value="1" {{ $invoice_layout->signature == 1 ? 'selected' : '' }}>On</option>
              <option value="0" {{ $invoice_layout->signature == 0 ? 'selected' : '' }}>Off</option>
            </select>
          </div>
        </div>
